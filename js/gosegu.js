...
AP.init({
    ...
    playList: [
        ...
        { 'icon': iconImage, 'title': '가을 아침', 'file': 'https://docs.google.com/uc?id=1C8b65p9ORyZhKXzgn_CQGEmEXkzJ9KbF' },
        { 'icon': iconImage, 'title': '고양이 (Feat. 아이유)', 'file': 'https://docs.google.com/uc?id=1EN-AWPm3Os7KcGJifKM1ulUdaseGkfyy' },
        { 'icon': iconImage, 'title': '그저 네게 맑아라(ただ君に晴れ)', 'file': 'https://docs.google.com/uc?id=1U5iBYCYq-QROQNG40awPJyQ5-u0zxwc6' },
        { 'icon': iconImage, 'title': '꽃에 망령(花に亡霊)', 'file': 'https://docs.google.com/uc?id=1avHxC72fcnFdo_nQH--d2-AXgMiEQ0FE' },
        { 'icon': iconImage, 'title': '내 손을 잡아', 'file': 'https://docs.google.com/uc?id=1EWlPho8yWR4kvLJBi57ZvB9WeaLkns7j' },
        { 'icon': iconImage, 'title': '네가 모르는 이야기 (君の知らない物語)', 'file': 'https://docs.google.com/uc?id=12yYJmtwu-TpXWLvtQogtF0ncckPxQSCJ' },
        { 'icon': iconImage, 'title': '봄 사랑 벚꽃 말고', 'file': 'https://docs.google.com/uc?id=1d-g48d6unlPOFAUe9kQxqgrYEADtLmvU' },
        { 'icon': iconImage, 'title': '사랑하긴했었나요스쳐가는인연', 'file': 'https://docs.google.com/uc?id=1vJ9PSC88iqD4B9kCk_b-jYAfzvAwOfNL' },
        { 'icon': iconImage, 'title': '세계는 사랑에 빠져있어 (世界は恋に落ちている)', 'file': 'https://docs.google.com/uc?id=1s4bmoi1u3NS6dsH_Mh3Q620ZgtAvX5t3' },
        { 'icon': iconImage, 'title': '시간과 낙엽', 'file': 'https://docs.google.com/uc?id=1pwSZYoXeVHn7nAcz8ppvjWNFIdWg2M1k' },
        { 'icon': iconImage, 'title': '신호등', 'file': 'https://docs.google.com/uc?id=1ziy_fMsYlvuzoEycFrpPsGCqoSSY4PhW' },
        { 'icon': iconImage, 'title': '심해의 리틀 크라이', 'file': 'https://docs.google.com/uc?id=1XvxXnMLEpAlRA0o0pvwmxuIMKo0qoJrD' },
        { 'icon': iconImage, 'title': '에잇(Prod._Feat. SUGA of BTS)', 'file': 'https://docs.google.com/uc?id=1wA102tUsFljYqZVEF9m2t_OZjc4sbpko' },
        { 'icon': iconImage, 'title': '여행', 'file': 'https://docs.google.com/uc?id=1btcI_bo8LRlp1bbiuhKd_HkbjlZwg0Ib' },
        { 'icon': iconImage, 'title': '오빠야', 'file': 'https://docs.google.com/uc?id=1f0Vrh4fewUUPnR36fxFzXEDodHGnadZm' },
        { 'icon': iconImage, 'title': '우리의 꿈', 'file': 'https://docs.google.com/uc?id=1c6x8CS5ySW0XMLPrK0YNDXlhAj9gPHJG' },
        { 'icon': iconImage, 'title': '이럴거면 그러지말지 (Feat. Young K)', 'file': 'https://docs.google.com/uc?id=1HhM0tdhDNJ1IAc1nOBIwNlYcrgRebR_4' },
        { 'icon': iconImage, 'title': '한 페이지가 될 수 있게', 'file': 'https://docs.google.com/uc?id=1e6YObly9-rHmqtaR3ylOtVimTjuxGwAq' },
        { 'icon': iconImage, 'title': '혜성', 'file': 'https://docs.google.com/uc?id=1evQYiXiVzyZ2Y4Ni2NhVuD5w7Xc0bUiv' },
        { 'icon': iconImage, 'title': '후라이의 꿈', 'file': 'https://docs.google.com/uc?id=1pK3GZSc6xKZwW_Qg9baegYI6Uq3PHoZS' },
        { 'icon': iconImage, 'title': 'Crescendo (크레셴도)', 'file': 'https://docs.google.com/uc?id=1p7dktwFa480FDhvpdW7A8dnP1SS6NyX0' },
        { 'icon': iconImage, 'title': 'Dolphin', 'file': 'https://docs.google.com/uc?id=17fH7gx8U0u6ONsd_hY7PP-I2wX-ZyrV8' },
        { 'icon': iconImage, 'title': 'Don_t say lazy', 'file': 'https://docs.google.com/uc?id=1mMgqkfXiyc2vmxx_FvVFibtDC_2H38Z4' },
        { 'icon': iconImage, 'title': 'God knows', 'file': 'https://docs.google.com/uc?id=1vkc2jP3HfiQFUxx38Tv-irTAb48Xv9ep' },
        { 'icon': iconImage, 'title': 'lost my music', 'file': 'https://docs.google.com/uc?id=1b9C__e3TzbqBaZZXJWSBy_WoFO3F606Q' },
        { 'icon': iconImage, 'title': 'SMILEY (Feat. BIBI)', 'file': 'https://docs.google.com/uc?id=1-2E2Hlm6n09oCxyEcePRgHxBsjwiY4h0' },
        { 'icon': iconImage, 'title': 'you -Visionen im Spiegel', 'file': 'https://docs.google.com/uc?id=1aS81cicOgeOPCXS5ANYV0cPsa3NR2Y9v' },
        { 'icon': iconImage, 'title': 'yours', 'file': 'https://docs.google.com/uc?id=1Vqki5vcdAKj7H_ApB5_vpecxnyLjq2F1' },
